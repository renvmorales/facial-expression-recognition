# Nesterov momentum batch gradient descent with AdaGrad used for training 
...
# train the model with a hyperparameters setting
    model.fit(X, Y, alpha=1e-4, epochs=5000, reg=0, mu=0.95, Nbatch=10, 
        show_fig=True)
...
# save the model object to a file
    ...
    joblib.dump(model, 'large_files/ANN_relu_batch3_AdaGrad.sav')
