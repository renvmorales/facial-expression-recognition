# Nesterov momentum batch gradient descent used for training a 'relu' ANN 
...
# train the model with a hyperparameters setting
    model.fit(X, Y, alpha=1e-3, epochs=5000, reg=0, mu=0.9, Nbatch=10,
        show_fig=True)
...
# save the model object to a file
    joblib.dump(model, 'large_files/ANN_relu_batch3.sav')
